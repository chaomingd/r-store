...
// remove subscribe
unsubscribe();
`,paraId:23,tocIndex:13},{value:"\u8BA2\u9605\u72B6\u6001\u503C\u7684\u53D8\u5316\uFF0C \u5F53\u4F20\u5165\u7684 keys \u6240\u5BF9\u5E94\u7684\u72B6\u6001\u503C\u53D8\u5316\u65F6\u89E6\u53D1\u51FD\u6570",paraId:24,tocIndex:14},{value:`// type define
subscribeWithKeys(
...
`,paraId:25,tocIndex:14},{value:"\u4F7F\u7528 asyncManger \u5904\u7406\u5F02\u6B65\u4EFB\u52A1\uFF0C\u652F\u6301\u5904\u7406\u7ADE\u6001\u95EE\u9898\uFF0C\u5931\u8D25\u91CD\u8BD5\u7B49",paraId:26,tocIndex:15},{value:`// type define
asyncManager(
  name: string,
  options?: {
    loadingKey?: string;
...
`,paraId:27,tocIndex:15},{value:"name",paraId:28,tocIndex:15},{value:" \u5728\u5F53\u524D store \u4E2D\u4E0D\u91CD\u590D\u5373\u53EF",paraId:28,tocIndex:15},{value:"options",paraId:28,tocIndex:15},{value:"loadingKey",paraId:29,tocIndex:15},{value:" loading \u72B6\u6001\u503C\u7684 key ",paraId:29,tocIndex:15},{value:"default: 'loading'",paraId:29,tocIndex:15},{value:"\u3002 ",paraId:29,tocIndex:15},{value:"this.setState({[loadingKey]: true})",paraId:29,tocIndex:15},{value:"errorKey",paraId:29,tocIndex:15},{value:" error \u72B6\u6001\u503C\u7684 key ",paraId:29,tocIndex:15},{value:"default: 'error'",paraId:29,tocIndex:15},{value:"\u3002",paraId:29,tocIndex:15},{value:"this.setState({[errorKey]: err})",paraId:29,tocIndex:15},{value:"config",paraId:29,tocIndex:15},{value:"retryCount",paraId:30,tocIndex:15},{value:" \u91CD\u8BD5\u7684\u6B21\u6570",paraId:30,tocIndex:15},{value:"retryInterval",paraId:30,tocIndex:15},{value:" \u91CD\u8BD5\u7684\u65F6\u95F4\u95F4\u9694\uFF0C\u5355\u4F4D ms",paraId:30,tocIndex:15},{value:"showLoading",paraId:29,tocIndex:15},{value:" \u662F\u5426\u66F4\u65B0 loading \u72B6\u6001\u503C",paraId:29,tocIndex:15},{value:`interface StoreState {
  userInfo: {
    name: string;
    id: string;
    nickName: string;
...
`,paraId:31,tocIndex:16},{value:"\u6267\u884C\u6240\u6709\u8BA2\u9605\u51FD\u6570",paraId:32,tocIndex:17},{value:`// type define
interface IDispatchOptions {
  silent: boolean;
}
...
// usage
store.dispatch();
`,paraId:33,tocIndex:17},{value:"\u4EE5\u5DE5\u5382\u7684\u8BBE\u8BA1\u6A21\u5F0F\u521B\u5EFA Model\uFF0C\u53EA\u80FD\u7528\u4E8E\u51FD\u6570\u5F0F\u7EC4\u4EF6",paraId:34,tocIndex:18},{value:`const store = useModel(modelConfig);
`,paraId:35,tocIndex:18},{value:"modelConfig \u53C2\u8003 ",paraId:36,tocIndex:18},{value:"ModelConfig",paraId:37,tocIndex:18}]},94810:function(a,n,e){e.r(n),e.d(n,{texts:function(){return t}});var r=e(79493);const t=[{value:`import { Model } from 'r-model-store';
